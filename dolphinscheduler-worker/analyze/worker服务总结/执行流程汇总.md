...
sequenceDiagram
    ...
    PER->>Master: RPC 报告 DISPATCHED 事件
    Master-->>PER: ACK
    ...
    alt 更新远程应用信息
        ...
        Note over TEC: 处理 RUNTIME_CONTEXT_CHANGE 事件
        ...
        PER->>PER: 添加到 eventChannels
        PER->>Master: RPC 报告 RUNTIME_CONTEXT_CHANGE 事件
        Master-->>PER: ACK
    end

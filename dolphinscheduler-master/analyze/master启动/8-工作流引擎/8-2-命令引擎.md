...
### 8.2 AbstractLifecycleEvent 事件体系
...
### 8.3 ILifecycleEventHandler 事件处理器体系
...
#### 8.3.3 AbstractWorkflowLifecycleEventHandler 处理流程
...
### 8.4 IWorkflowStateAction 状态动作体系
...
#### 8.4.3 WorkflowExecutionStatus 与 IWorkflowStateAction 映射关系
...
### 8.7 AbstractLifecycleEvent 与 ILifecycleEventHandler 的关系
...
### 8.8 IWorkflowStateAction 与 WorkflowExecutionStatus 的关系
...
#### 8.9.2 状态机模式（State Machine Pattern）
...
#### 8.9.4 模板方法模式（Template Method Pattern）
...
### 8.11 WorkflowRunningStateAction 详细分析
...
### 8.12 从 AbstractWorkflowLifecycleEventHandler 开始的完整处理链

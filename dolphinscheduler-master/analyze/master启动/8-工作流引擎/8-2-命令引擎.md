...
### 9.2 AbstractLifecycleEvent 事件体系
...
### 9.3 ILifecycleEventHandler 事件处理器体系
...
### 9.4 IWorkflowStateAction 状态动作体系
...
### 9.7 AbstractLifecycleEvent 与 ILifecycleEventHandler 的关系
...
### 9.8 IWorkflowStateAction 与 WorkflowExecutionStatus 的关系
...
### 9.12 从 AbstractWorkflowLifecycleEventHandler 开始的完整处理链

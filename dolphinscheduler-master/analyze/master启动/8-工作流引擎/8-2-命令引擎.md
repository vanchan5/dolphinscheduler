...
flowchart TD
    ...
    subgraph AssembleData[数据组装流程]
        ...
        A5[assembleWorkflowEventBus<br/>组装事件总线]
        A6[assembleWorkflowExecutionGraph<br/>组装执行图<br/>子类实现]
        A7[创建WorkflowExecutionRunnable]
    end
    ...
    A5 --> A6
    A6 --> A7
    A7 --> RegisterRepository[注册到WorkflowRepository]
